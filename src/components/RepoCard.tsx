...
export const RepoCard: React.FC<RepoCardProps> = ({ repo, index = 0 }) => {
  ...
  const getCardFrameClass = () => {
    ...
    if (repo.velocityLabel === 'ESTABLISHED') {
      return 'bg-slate-950/80 border border-slate-800/80 hover:border-cyan-500/50 hover:bg-slate-900/90';
    }
    if (repo.velocityLabel === 'HOT RISING') {
      return 'bg-slate-950/80 border border-amber-500/40 hover:border-amber-400 hover:bg-slate-900/90';
    }
